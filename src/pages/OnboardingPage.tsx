...
export const OnboardingPage: React.FC<OnboardingPageProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(
        err.message ||
          "Failed to calculate statistics. Please check your inputs.",
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-400">
              We use these details to estimate your metabolism.
            </p>
          </div>
          ...
          <GlassCard className="space-y-5">
            ...
            <div className="space-y-2">
              <label
                ...
                className="text-xs font-semibold text-gray-400 uppercase tracking-wider flex items-center gap-1.5"
              >
      ...
      {step === 2 && (
        <div className="space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-400">
              Used to compute Body Mass Index and energy rates.
            </p>
          </div>
          ...
          <GlassCard className="space-y-6">
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs font-semibold text-gray-400 uppercase tracking-wider">
                ...
                <span className="text-teal-400 font-bold normal-case text-sm">
                  {height} cm
                </span>
              </div>
              <input
      ...
      {step === 3 && (
        <div className="space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-400">
              Activity and goal adjustments dictate your target calories.
            </p>
          </div>
      ...
      {step === 4 && results && (
        <div className="space-y-6 animate-fade-in">
          <div className="space-y-1 text-center">
            ...
            <p className="text-sm text-gray-400">
              Based on your metabolic profile computations.
            </p>
          </div>
          ...
          <GlassCard className="text-xs text-gray-400 leading-relaxed space-y-2">
            <p>
              Your <strong>Basal Metabolic Rate (BMR)</strong> is the energy
              required to keep your body functioning at rest.
            </p>
            <p>
              Your <strong>Total Daily Energy Expenditure (TDEE)</strong>{" "}
              factors in your activity.
            </p>
            <p>
              To satisfy your goal, we established a daily target of{" "}
              <strong className="text-teal-400">
                {results.targetCal} kcal
              </strong>
              .
            </p>
          </GlassCard>
